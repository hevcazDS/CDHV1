...
//   node --test tests/test_suscripcion_job.js
...
test('genera cargo de la vencida: pedido canal suscripcion + link generado', () => {
...
test('avanza proximo_cobro un mes (no vuelve a estar vencida)', () => {
...
test('segundo tick: no re-cobra (idempotente por proximo_cobro)', () => {
...
test('suscripción suspendida no se cobra', () => {
