...
t('SQLite: cantidad 1.5 sobrevive en columna INTEGER-affinity', () => {
...
t('inventario: descuento decimal (10 − 1.5 = 8.5)', () => {
...
t('insertarPedidoConCarrito acepta carrito con cantidad decimal', () => {
...
t('unidad_medida: default pza, validación de valores', () => {
...
console.log('\n' + ok + '/4 OK — venta por peso/granel funciona de punta a punta.');
