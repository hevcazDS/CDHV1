...
//   node --test tests/test_unidad_compra.js
...
test('2 cajas × factor 100 → +200 piezas al stock', () => {
...
test('sin en_unidad_compra: entrada normal (factor ignorado)', () => {
...
test('producto sin factor (default 1): en_unidad_compra no altera nada', () => {
