...
test('1. Matriz de permisos', () => {
    const { permite, rangoDe, ROLES_CREABLES_POR_GERENTE, esAuditor } = require('../dashboard/permisos');
...
test('2. PIN de autorización', () => {
    const { rangoDe } = require('../dashboard/permisos');
...
test('3. Kardex (movimiento + saldo)', () => {
...
test('4. Nómina: sin impuestos = bruto; con impuestos retiene ISR+IMSS', () => {
