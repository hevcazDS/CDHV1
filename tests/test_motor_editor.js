...
//   node --test tests/test_motor_editor.js
...
test('guardar el grafo tal cual → versión nueva activa con posiciones', () => {
...
test('candado: borrar un nodo delegado se rechaza', () => {
...
test('candado: des-delegar un nodo desde el editor se rechaza', () => {
...
test('linter: arista a destino inexistente se rechaza (no persiste)', () => {
...
test('agregar un nodo de conversación nuevo con arista válida → OK', () => {
...
test('pieza final (params.terminal): sin salida NO avisa; sin el flag SÍ avisa', () => {
