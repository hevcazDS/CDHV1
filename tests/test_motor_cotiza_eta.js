...
//   node --test tests/test_motor_cotiza_eta.js
...
test('cotizar OFF → inactivo (gating por módulo, no calcula)', () => {
...
test('cotizar ON → subtotal+envío+total correctos; envío con costo', () => {
...
test('cotizar: sobre el umbral el flete es "gratis" (regla: gratis solo en flete)', () => {
...
test('tiempo_entrega OFF → inactivo; ON → devuelve eta_fecha humana', () => {
...
test('catálogo del editor expone ambas como NO selladas con sus salidas', () => {
...
test('DIÁLOGO: los 4 tonos renderizan no-vacío y llenan los slots', () => {
...
test('DIÁLOGO editable: frase_<clave> override gana sobre el tono', () => {
