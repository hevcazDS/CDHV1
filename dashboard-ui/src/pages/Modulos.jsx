...
const MODULOS = [
  ...
  { key: 'recordatorio_fiado_activo', titulo: '💸 Recordatorio de fiado vencido', desc: 'El bot le recuerda al cliente (una vez, con tono cortés) su compra a crédito ya vencida. Requiere el módulo de Ventas a crédito' },
  ...
  { key: 'correo_activo', titulo: '📧 Correo (redactar y enviar)', desc: 'Redacta y envía correos con adjuntos (imágenes, cotizaciones/facturas/reportes en PDF, archivos) usando tu cuenta de Gmail con clave de aplicación. Configura el correo en Prime. La bandeja de entrada (leer correos) llega después' },
