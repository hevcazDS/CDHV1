...
- 🟡 **Rol mesero/comisionista** no existen (cubiertos por `operador`+`cobrado_por`/comisiones); propina de mesa se guarda pero **sin `id_mesero` ni pantalla de reparto** (hueco MEDIO de la auditoría de herramientas).
